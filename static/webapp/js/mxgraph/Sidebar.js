...
Sidebar.prototype.addMiscPalette = function(expand)
{
	var sb = this;
	var lineTags = 'line lines connector connectors connection connections arrow arrows '
	// console.log(this.gearImage, 'gearImage')
	var fns = [
...
Sidebar.prototype.createVertexTemplateFromCells = function(cells, width, height, title, showLabel, showTitle, allowCellsInserted)
{
	...
	// console.log('xml', this.graph.compress(mxUtils.getXml(this.graph.encodeCells(cells))), cells);
	// console.log(cells, allowCellsInserted, 'allowCellsInserted')
	// console.log(mxUtils.getXml(), 'xml')
...
Sidebar.prototype.addImagePalette = function(id, title, prefix, postfix, items, titles, tags)
{
	...
	for (var i = 0; i < items.length; i++)
	{
		(mxUtils.bind(this, function(item, title, tmpTags)
		{
			...
			fns.push(this.createVertexTemplateEntry('shape=image;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;imageAspect=1;aspect=fixed;image=' + prefix + item + postfix,
