(function()
{
	 ...
	 * 
	 */
	Sidebar.prototype.defaultEntries = 'resourceLibrary; general; basic; arrows2'; //uml;er;bpmn;flowchart;
	...
	Sidebar.prototype.configuration = [{id: 'general', libs: ['general', 'misc', 'advanced']}, {id: 'uml'}, {id: 'search'}, {id: 'er'},
	                                   ...
	                                   {id: 'clipart', prefix: null, libs: ['computer',  'clipart', 'networking', 'people', 'telco']}, //'finance',
	...
	Sidebar.prototype.init = function()
	{
		...
		this.entries = [
            			...
            			entries: [
            			          ...
            			          {title: mxResources.get('resourceLibrary'), id: 'resourceLibrary', image: IMAGE_PATH + '/sidebar-resource.png'},
            		  ]},
				...
				if (mxEvent.getSource(evt).nodeName == 'BUTTON')
				{
					...
					this.editorUi.convertImages(doc.documentElement, mxUtils.bind(this, function(body)
					{
						var html = '<!DOCTYPE html><html><head><link rel="stylesheet" type="text/css" ' +
							'href="' + STYLE_PATH + '/grapheditor.css"></head>' +
	...
	Sidebar.prototype.initPalettes = function()
	{
		...
		this.addRESOURCESPalette(); //添加的资源图库
		...
		// this.addStencilPalette('resource_Library', mxResources.get('resourceLibrary'), dir + '/myicon.xml',
		// 		';html=1;' + mxConstants.STYLE_VERTICAL_LABEL_POSITION + '=bottom;' + mxConstants.STYLE_VERTICAL_ALIGN + '=top;' + mxConstants.STYLE_STROKEWIDTH + '=2;strokeColor=#000000;');

		this.addArrows2Palette();
				
		this.addImagePalette('computer', '电脑类库', imgDir
	 ...
	 //            'Piggy Bank', 'Safe', 'Shopping Basket', 'Stock Down', 'Stock Up']);
		this.addImagePalette('clipart', '应用类图', imgDir
		...
		this.addImagePalette('networking', '网络类图', imgDir
		...
		this.addImagePalette('people', '人像类图', imgDir
		...
		this.addImagePalette('telco', '电信类图', imgDir
	...
	Sidebar.prototype.itemClicked = function(cells, ds, evt)
	{
		...
		{
			var target = this.cloneCell(cells[0]);
