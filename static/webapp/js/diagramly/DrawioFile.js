...
{
	console.log(revision, success, error, unloading, overwrite, manual, 'saves')
	if (!this.isEditable())
	{
		if (error != null)
		{
...
DrawioFile.prototype.getUrlParam = function(paraName) {
...
{
	if (!this.inConflictState && (this.ui.statusContainer == undefined || this.ui.statusContainer != null) && this.ui.getCurrentFile() == this)
	{
	...
	//		}
			...
			if(isModle != 'PRIMITIVE'){ //图元模板 创建里，不显示全局保存按钮
			this.ui.editor.setStatus('<div title="'+ status +
