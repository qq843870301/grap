 ...
 */
GraphViewer.prototype.editBlankUrl = 'http://'+ window.location.host ; //'https://www.draw.io/';

/**
 * Base URL for relative images.
 */
GraphViewer.prototype.imageBaseUrl ='http://'+ window.location.host//'https://www.draw.io/';
	...
	if (xmlNode != null)
	{
		...
		if (container != null)
		{
			var render = mxUtils.bind(this, function()
			{
				...
				{
					console.log(key, 'getImageFromBundles')
...
GraphViewer.prototype.addSizeHandler = function()
{
	...
	console.log(bounds, 'addSizeHandler')
...
GraphViewer.createViewerForElement = function(element, callback)
{
	...
	console.log(element, data, 'createViewerForElement')
	if (data != null)
	{
